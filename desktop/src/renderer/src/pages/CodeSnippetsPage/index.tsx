...
import { EMPTY_ICONS, STATUS_ICONS, ACTION_ICONS, Scissors, Clipboard, DeleteOne } from '../../utils/statusMessages'
const scissorI = React.createElement(Scissors, { size: 16, fill: 'currentColor', theme: 'outline' })
